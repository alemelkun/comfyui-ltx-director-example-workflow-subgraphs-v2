# LTX Director Example Workflow Subgraphs v2
ComfyUI workflow Dockerized via [comfyui-wizard](https://comfy.getrunpod.io).
Submission: https://comfy.getrunpod.io/dashboard/submissions/kd7aba7hmr64dte0smzg3xycy587jmjt
## Pull the prebuilt image

We've already built and published this image on Docker Hub:

```bash
docker pull timpietruskyrunpod/comfyui-wizard:kd7aba7hmr64dte0smzg3xycy587jmjt
docker run --rm --gpus all -p 8188:8188 timpietruskyrunpod/comfyui-wizard:kd7aba7hmr64dte0smzg3xycy587jmjt
```
